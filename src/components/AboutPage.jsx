...
function AboutPage() {
  return (
    <>
      <div className="relative z-10 flex flex-col items-center justify-center h-fit pt-40 p-20 w-screen ">
        <div className="grid relative z-10 grid-cols-2 p-8 place-items-center place-content-center gap-2  w-full min-h-screen bg-image">
          ...
          <div className="mesh1 h-80 w-96 blur-3xl opacity-0 md:opacity-60 absolute -bottom-4 -right-4 z-0 bg-[conic-gradient(var(--tw-gradient-stops))] from-gray-200 via-gray-400 to-gray-600"></div>
        </div>
      </div>
    </>
  );
